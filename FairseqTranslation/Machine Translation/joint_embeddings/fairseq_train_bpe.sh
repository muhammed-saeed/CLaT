...
fairseq-train "PATH_TO/pcm_en.tokenized.pcm-en" \
    ...
    --no-epoch-checkpoints --wandb-project "WANDB PROJECT NAME" \
    --log-format=json --log-interval=10 2>&1    |  tee  "PATH_training_log.log"
